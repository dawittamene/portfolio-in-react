...
const Works = () => {
  return (
    <section id="works">
    <h2 className="workstitles">My Portfolio</h2>
    <span className="worksDescribtion">Reference site about Lorem Ipsum, giving information on its origins,<br /> as well as a random Lipsum generator</span>
    ...
    <button className='workBnt'> See More</button>
    </section>
  )
}
